...
describe(`collection functions`, () => {
  for (const lits of [new Lits(), new Lits({ debug: true })]) {
    describe(`count`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(count [])`)).toEqual(DataType.zero)
        expect(lits.dataType(`(count {})`)).toEqual(DataType.zero)
        expect(lits.dataType(`(count "Albert")`)).toEqual(DataType.nonZeroNumber)
      })
    })
    ...
    describe(`get`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(get "Albert" 1)`)).toEqual(DataType.nilableString)
        expect(lits.dataType(`(get [1 2 3] 1)`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get {:a 1 :b 2} 1)`)).toEqual(DataType.unknown)
      })
    })
    ...
    describe(`get-in`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(get-in "Albert" nil)`)).toEqual(DataType.nonEmptyString)
        expect(lits.dataType(`(get-in [] nil)`)).toEqual(DataType.emptyArray)
        expect(lits.dataType(`(get-in [1 2] nil)`)).toEqual(DataType.nonEmptyArray)
        expect(lits.dataType(`(get-in {} nil)`)).toEqual(DataType.emptyObject)
        expect(lits.dataType(`(get-in { :a 12 } nil)`)).toEqual(DataType.nonEmptyObject)
        expect(lits.dataType(`(get-in #"^test" nil)`)).toEqual(DataType.regexp)
        expect(lits.dataType(`(get-in 123 nil)`)).toEqual(DataType.nonZeroNumber)
        expect(lits.dataType(`(get-in false nil)`)).toEqual(DataType.false)

        expect(lits.dataType(`(get-in "Albert" [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in [] [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in [1 2] [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in {} [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in #"^test" [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in 123 [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in false [])`)).toEqual(DataType.unknown)

        expect(lits.dataType(`(get-in "Albert" [1] nil)`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in [] [1] :abc)`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in [1 2] [1] 1)`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in {} [1] [])`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in #"^test" [1] {})`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in 123 [1] true)`)).toEqual(DataType.unknown)
        expect(lits.dataType(`(get-in false [1] #"hey")`)).toEqual(DataType.unknown)
      })
    })
    ...
    describe(`contains?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(contains? [] 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? [1] 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? [1 2 3] 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? (object) :a)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? (object :a 1 :b 2) :a)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? [] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? [1] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? [1 2 3] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? (object) 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? (object :a 1 :b 2) 2)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? "Albert" 0)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? "Albert" 5)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? "Albert" 6)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(contains? "Albert" -1)`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`has?`, () => {
      ...
      test(`dataTypes`, () => {
        expect(lits.dataType(`(has? [] 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? [1] 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? [1 2 3] 0)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? (object) :a)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? (object :a 1 :b 2) 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? (object :a 1 :b 2) :a)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? [] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? [1] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? [1 2 3] :1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? (object) 1)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? "Albert" :A)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? "Albert" :a)`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has? "Albert" 1)`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`has-some?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(has-some? [] [1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [1] [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [1] [1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [1 2 3] [0])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [1 2 3] [0 1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? (object) [:a])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? (object :a 1 :b 2) [0])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? (object :a 1 :b 2) [0 1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? "Albert" "xyz")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? "Albert" ["Alb" "ert"])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? "Albert" ["A"])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? "Albert" "xyzl")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [:a :b :c :d] "xyz")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-some? [:a :b :c :d] "xyzc")`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`has-every?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(has-every? [] [1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [1] [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [1] [1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [1 2 3] [0 1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [1 2 3] [1 2])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? (object) [:a])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? (object :a 1 :b 2) [0 1])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? (object :a 1 :b 2) [1 2])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? "Albert" "xyz")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? "Albert" ["Alb" "ert"])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? "Albert" ["A"])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? "Albert" "treblA")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [:a :b :c :d] "xyz")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(has-every? [:a :b :c :d] "dcba")`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`every?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(every? number? [1 2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? number? [:1 :2 :3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? number? [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? number? "")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? number? {})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? (fn [x] (zero? (mod x 2))) [2 4 6])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? (fn [x] (>= x :a)) "abc")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? (fn [x] (>= x :a)) "abC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`not-every?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(not-every? number? [1 2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? number? [:1 :2 :3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? number? [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? number? "")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? number? {})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? (fn [x] (zero? (mod x 2))) [2 4 6])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? (fn [x] (>= x :a)) "abc")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? (fn [x] (>= x :a)) "abC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`any?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(any? number? [1 2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? number? [1 :2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? number? [:1 :2 :3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? number? [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? number? "")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? number? {})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? (fn [x] (zero? (mod x 2))) [1 3 6])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? (fn [x] (zero? (mod x 2))) [1 3 5])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? (fn [x] (>= x :a)) "abc")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? (fn [x] (>= x :a)) "abC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? (fn [x] (>= x :a)) "ABC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(any? #(even? (second %1)) {:a 1 :b 3})`)).toEqual(DataType.boolean)
      })
    })
    ...
    describe(`not-any?`, () => {
      ...
      test(`dataType`, () => {
        expect(lits.dataType(`(not-any? number? [1 2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? number? [1 :2 3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? number? [:1 :2 :3])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? number? [])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? number? "")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? number? {})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? (fn [x] (zero? (mod x 2))) [1 3 6])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? (fn [x] (zero? (mod x 2))) [1 3 5])`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? (fn [x] (>= x :a)) "abc")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? (fn [x] (>= x :a)) "abC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? (fn [x] (>= x :a)) "ABC")`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(DataType.boolean)
        expect(lits.dataType(`(not-any? #(even? (second %1)) {:a 1 :b 3})`)).toEqual(DataType.boolean)
      })
    })
