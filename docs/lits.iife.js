  ...
  ***************************************************************************** */
      ...
      var _this =
        _super.call(
          ...
          'Expected function, got '
            .concat(valueToString$1(fn), '.')
            .concat(sourceCodeInfo ? ' '.concat(sourceCodeInfo) : ''),
        ) || this
      _this.line = sourceCodeInfo === 'EOF' || sourceCodeInfo === null ? null : sourceCodeInfo.line
      _this.column = sourceCodeInfo === 'EOF' || sourceCodeInfo === null ? null : sourceCodeInfo.column
  ...
  var UndefinedSymbolError = /** @class */ (function (_super) {
    ...
    function UndefinedSymbolError(symbolName, sourceCodeInfo) {
      var _this =
        _super.call(
          this,
          "Undefined symbol '".concat(symbolName, "'").concat(sourceCodeInfo ? ' '.concat(sourceCodeInfo) : ''),
        ) || this
      _this.line = sourceCodeInfo === 'EOF' || sourceCodeInfo === null ? null : sourceCodeInfo.line
      _this.column = sourceCodeInfo === 'EOF' || sourceCodeInfo === null ? null : sourceCodeInfo.column
  ...
  function assert$2(value, sourceCodeInfo, options) {
    ...
    if (!is$2(value, options)) {
      throw new LitsError(
        'Expected '
          .concat(options.nonEmpty ? 'non empty string' : options.char ? 'character' : 'string', ', got ')
          .concat(valueToString$1(value), '.'),
  ...
  function getRangeString(options) {
    if (
      ...
      return ''
        .concat(typeof options.gt === 'number' ? ''.concat(options.gt, ' < n ') : ''.concat(options.gte, ' <= n '))
        .concat(typeof options.lt === 'number' ? '< '.concat(options.lt) : '<= '.concat(options.lte))
    }
  ...
  function getNumberTypeName(options) {
    ...
    return [sign, finite, numberType, range]
      .filter(function (x) {
        return !!x
      })
      .join(' ')
  ...
  function assert$1(value, sourceCodeInfo, options) {
    ...
    if (!is$1(value, options)) {
      throw new LitsError(
        'Expected '.concat(getNumberTypeName(options), ', got ').concat(valueToString$1(value), '.'),
        getSourceCodeInfo(value, sourceCodeInfo),
      )
    }
  }
  ...
  function assert(value, sourceCodeInfo, options) {
    ...
    if (!is(value, options)) {
      ...
      throw new LitsError(
        'Expected '
          .concat(options.type ? ''.concat(options.type, '-') : '', 'token')
          .concat(typeof options.value === 'string' ? " value='".concat(options.value, "'") : '', ', got ')
          .concat(valueToString$1(value), '.'),
        getSourceCodeInfo(value, sourceCodeInfo),
      )
    }
  ...
  var Asserter = /** @class */ (function () {
    ...
    Asserter.prototype.assert = function (value, sourceCodeInfo) {
      if (!this.predicate(value)) {
        throw new LitsError(
          'Expected '.concat(this.typeName, ', got ').concat(valueToString$1(value), '.'),
          getSourceCodeInfo(value, sourceCodeInfo),
        )
      }
    }
  ...
  var stringOrNumber = new Asserter('string or number', function (value) {
    return typeof value === 'string' || typeof value === 'number'
  })
  var any = new Asserter('Any', function (value) {
    return value !== undefined
  })
  var sequence = new Asserter('Seq', function (value) {
    return Array.isArray(value) || string.is(value)
  })
  ...
  var collection = new Asserter('Coll', function (value) {
    return sequence.is(value) || object.is(value)
  })
  var array = new Asserter('Arr', function (value) {
  ...
  var stringArray = new Asserter('string array', function (value) {
    return (
      Array.isArray(value) &&
  ...
  var charArray = new Asserter('character array', function (value) {
    return (
      Array.isArray(value) &&
      value.every(function (v) {
  ...
  var regExp = new Asserter('RegExp', function (value) {
    return value instanceof RegExp
  })
  var stringOrRegExp = new Asserter('string or RegExp', function (value) {
  ...
  function assertNumberOfParams(count, node) {
    ...
    if (typeof count === 'number') {
      if (length !== count) {
        throw new LitsError(
          'Wrong number of arguments to "'
            .concat(node.name, '", expected ')
            .concat(count, ', got ')
            .concat(valueToString$1(length), '.'),
      ...
      if (typeof min === 'number' && length < min) {
        throw new LitsError(
          'Wrong number of arguments to "'
            .concat(node.name, '", expected at least ')
            .concat(min, ', got ')
            .concat(valueToString$1(length), '.'),
          sourceCodeInfo,
        )
      ...
      if (typeof max === 'number' && length > max) {
        throw new LitsError(
          'Wrong number of arguments to "'
            .concat(node.name, '", expected at most ')
            .concat(max, ', got ')
            .concat(valueToString$1(length), '.'),
          sourceCodeInfo,
        )
  ...
  function assertEventNumberOfParams(node) {
    ...
    if (length % 2 !== 0) {
      throw new LitsError(
        'Wrong number of arguments, expected an even number, got '.concat(valueToString$1(length), '.'),
        node.token.sourceCodeInfo,
      )
    }
  }
  ...
  var andSpecialExpression = {
    parse: function (tokens, position, _a) {
      ...
      var _b = parseTokens(tokens, position),
        newPosition = _b[0],
        params = _b[1]
      return [
        newPosition + 1,
  ...
  function parseFunctionArguments(tokens, position, parsers) {
    ...
    var parseArgument = parsers.parseArgument,
      parseBindings = parsers.parseBindings
    var bindings = []
    ...
    while (!(tkn.type === 'paren' && tkn.value === ']')) {
      if (state === 'let') {
        ...
        var _b = parseArgument(tokens, position),
          newPosition = _b[0],
          node = _b[1]
  ...
  var defSpecialExpression = {
    ...
    validate: function (node) {
      return assertNumberOfParams(2, node)
    },
  }
  ...
  function parseLoopBinding(tokens, position, _a) {
    ...
    var parseBinding = _a.parseBinding,
      parseBindings = _a.parseBindings,
      parseToken = _a.parseToken
    var bindingNode
  ...
  function evaluateLoop(returnResult, node, contextStack, evaluateAstNode) {
    ...
    var result = []
    var bindingIndices = loopBindings.map(function () {
      return 0
    })
    var abort = false
    while (!abort) {
      ...
      bindingsLoop: for (var bindingIndex = 0; bindingIndex < loopBindings.length; bindingIndex += 1) {
        var _a = asValue(loopBindings[bindingIndex], sourceCodeInfo),
          binding = _a.binding,
          letBindings = _a.letBindings,
          whenNode = _a.whenNode,
          whileNode = _a.whileNode,
  ...
  var forSpecialExpression = {
    parse: function (tokens, position, parsers) {
      return parseLoop('for', tokens, position, parsers)
    },
    evaluate: function (node, contextStack, helpers) {
      return evaluateLoop(true, node, contextStack, helpers.evaluateAstNode)
    },
  }
  var doseqSpecialExpression = {
    parse: function (tokens, position, parsers) {
      return parseLoop('doseq', tokens, position, parsers)
    },
    evaluate: function (node, contextStack, helpers) {
      return evaluateLoop(false, node, contextStack, helpers.evaluateAstNode)
    },
  }
  ...
  var ifLetSpecialExpression = {
    parse: function (tokens, position, _a) {
      ...
      var parseBindings = _a.parseBindings,
        parseTokens = _a.parseTokens
      var firstToken = token.as(tokens[position], 'EOF')
      var bindings
      ;(_b = parseBindings(tokens, position)), (position = _b[0]), (bindings = _b[1])
      if (bindings.length !== 1) {
        throw new LitsError(
          'Expected exactly one binding, got '.concat(valueToString$1(bindings.length)),
    ...
    validate: function (node) {
      return assertNumberOfParams({ min: 1, max: 2 }, node)
    },
  }
  ...
  var ifNotSpecialExpression = {
    ...
    validate: function (node) {
      return assertNumberOfParams({ min: 2, max: 3 }, node)
    },
  }
        ...
        try {
          ...
          if (error instanceof RecurSignal) {
            ...
            if (params_1.length !== node.bindings.length) {
              throw new LitsError(
                'recur expected '
                  .concat(node.bindings.length, ' parameters, got ')
                  .concat(valueToString$1(params_1.length)),
                sourceCodeInfo,
              )
            }
  ...
  var recurSpecialExpression = {
    ...
    evaluate: function (node, contextStack, _a) {
      var evaluateAstNode = _a.evaluateAstNode
      var params = node.params.map(function (paramNode) {
        return evaluateAstNode(paramNode, contextStack)
      })
  ...
  var throwSpecialExpression = {
    parse: function (tokens, position, _a) {
      var parseToken = _a.parseToken
      var firstToken = token.as(tokens[position], 'EOF')
      var _b = parseToken(tokens, position),
        newPosition = _b[0],
        messageNode = _b[1]
      position = newPosition
      token.assert(tokens[position], 'EOF', { type: 'paren', value: ')' })
  ...
  var timeSpecialExpression = {
    ...
    validate: function (node) {
      return assertNumberOfParams(1, node)
    },
  }
  ...
  var trySpecialExpression = {
    parse: function (tokens, position, _a) {
      ...
      if (catchNode.value !== 'catch') {
        throw new LitsError(
          "Expected 'catch', got '".concat(catchNode.value, "'."),
    ...
    evaluate: function (node, contextStack, _a) {
      ...
      try {
        ...
        var newContext = ((_b = {}), (_b[node.error.value] = { value: any.as(error, node.token.sourceCodeInfo) }), _b)
  ...
  var whenFirstSpecialExpression = {
    ...
    evaluate: function (node, contextStack, _a) {
      ...
      if (!sequence.is(evaluatedBindingForm)) {
        throw new LitsError(
          'Expected undefined or a sequence, got '.concat(valueToString$1(evaluatedBindingForm)),
          node.token.sourceCodeInfo,
        )
      }
    ...
    validate: function (node) {
      return assertNumberOfParams({ min: 0 }, node)
    },
  }
  ...
  var whenNotSpecialExpression = {
    ...
    validate: function (node) {
      return assertNumberOfParams({ min: 1 }, node)
    },
  }
  ...
  var bitwiseNormalExpression = {
    ...
    'bit-and': {
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 2 }, node)
      },
    },
    'bit-and-not': {
      evaluate: function (_a, sourceCodeInfo) {
  ...
  function cloneAndGetMeta(originalColl, keys, sourceCodeInfo) {
    ...
    var innerCollMeta = butLastKeys.reduce(
      function (result, key) {
    ...
    if (object.is(coll)) {
      ...
      if (Array.isArray(coll)) {
        ...
        var result = coll.split('').map(function (elem, index) {
          if (intKey_1 === index) {
            return string.as(
              executeFunction(fn, __spreadArray([elem], params, true), sourceCodeInfo, contextStack),
              sourceCodeInfo,
              {
                char: true,
              },
        ...
        if (intKey_1 === coll.length) {
          result[intKey_1] = string.as(
            executeFunction(fn, __spreadArray([undefined], params, true), sourceCodeInfo, contextStack),
            sourceCodeInfo,
            {
              char: true,
            },
  ...
  function assoc(coll, key, value, sourceCodeInfo) {
    ...
    if (Array.isArray(coll) || typeof coll === 'string') {
      ...
      if (typeof coll === 'string') {
        ...
        return ''
          .concat(coll.slice(0, key))
          .concat(value)
          .concat(coll.slice(key + 1))
      }
  ...
  var collectionNormalExpression = {
    ...
    assoc: {
      ...
      validate: function (node) {
        return assertNumberOfParams(3, node)
      },
    },
    'assoc-in': {
      evaluate: function (_a, sourceCodeInfo) {
        var originalColl = _a[0],
          keys = _a[1],
          value = _a[2]
        ...
        var _b = cloneAndGetMeta(originalColl, keys, sourceCodeInfo),
          coll = _b.coll,
          innerCollMeta = _b.innerCollMeta
    ...
    update: {
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 3 }, node)
      },
    },
    'update-in': {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        var _c = cloneAndGetMeta(originalColl, keys, sourceCodeInfo),
          coll = _c.coll,
          innerCollMeta = _c.innerCollMeta
        var lastKey = stringOrNumber.as(keys[keys.length - 1], sourceCodeInfo)
        var parentKey = stringOrNumber.as(keys[keys.length - 2], sourceCodeInfo)
        if (array.is(innerCollMeta.parent)) {
          number.assert(parentKey, sourceCodeInfo)
    ...
    'every?': {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        collection.assert(coll, sourceCodeInfo)
        if (Array.isArray(coll)) {
          return coll.every(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
        }
        if (string.is(coll)) {
          return coll.split('').every(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
        }
        return Object.entries(coll).every(function (elem) {
          return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
        })
      },
      validate: function (node) {
    ...
    'any?': {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        collection.assert(coll, sourceCodeInfo)
        if (Array.isArray(coll)) {
          return coll.some(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
        }
        if (string.is(coll)) {
          return coll.split('').some(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
        }
        return Object.entries(coll).some(function (elem) {
          return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
        })
      },
      validate: function (node) {
  ...
  var evaluateMap = function (params, sourceCodeInfo, contextStack, _a) {
    ...
    if (params.length === 2) {
      if (array.is(firstList)) {
        return firstList.map(function (elem) {
          return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
        })
      } else {
        return firstList
      ...
      if (isStringSeq) {
        ...
        var _loop_1 = function (i) {
          var fnParams = params.slice(1).map(function (l) {
            return l[i]
          })
  ...
  var sequenceNormalExpression = {
    ...
    position: {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        sequence.assert(seq, sourceCodeInfo)
        if (string.is(seq)) {
          var index = seq.split('').findIndex(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
          return index !== -1 ? index : null
        } else {
          var index = seq.findIndex(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
          return index !== -1 ? index : null
        }
    ...
    slice: {
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 1, max: 3 }, node)
      },
    },
    some: {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        if (string.is(seq)) {
          return (_c = seq.split('').find(function (elem) {
            return executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })) !== null && _c !== void 0
            ? _c
            : null
    ...
    'drop-while': {
      evaluate: function (_a, sourceCodeInfo, contextStack, _b) {
        ...
        litsFunction.assert(fn, sourceCodeInfo)
        if (Array.isArray(seq)) {
          var from_1 = seq.findIndex(function (elem) {
            return !executeFunction(fn, [elem], sourceCodeInfo, contextStack)
          })
          return seq.slice(from_1)
        }
        var charArray = seq.split('')
        var from = charArray.findIndex(function (elem) {
          return !executeFunction(fn, [elem], sourceCodeInfo, contextStack)
        })
    ...
    partition: {
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 2, max: 4 }, node)
      },
    },
    'partition-all': {
      evaluate: function (params, sourceCodeInfo) {
  ...
  var mathNormalExpression = {
    ...
    'rand!': {
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 0, max: 1 }, node)
      },
    },
    'rand-int!': {
      evaluate: function (_a, sourceCodeInfo) {
    ...
    'max-safe-integer': {
      ...
      validate: function (node) {
        return assertNumberOfParams(0, node)
      },
    },
    'min-safe-integer': {
      evaluate: function () {
  ...
  var miscNormalExpression = {
    ...
    'debug!': {
      ...
      validate: function (node) {
        return assertNumberOfParams({ max: 1 }, node)
      },
    },
    boolean: {
      evaluate: function (_a) {
  ...
  function contextStackToString(contextStack) {
    return contextStack.stack.reduce(function (result, context, index) {
      return ''
        .concat(result, 'Context ')
        .concat(index)
        .concat(context === contextStack.globalContext ? ' - Global context' : '', '\n')
  ...
  function contextToString(context) {
    ...
    var maxKeyLength = Math.max.apply(
      Math,
  ...
  var assertNormalExpression = {
      ...
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (first !== second) {
          throw new AssertionError(
            'Expected '.concat(first, ' to be ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
    ...
    'assertNot=': {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (first === second) {
          throw new AssertionError(
            'Expected '.concat(first, ' not to be ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
    ...
    assertEqual: {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (!deepEqual(any.as(first, sourceCodeInfo), any.as(second, sourceCodeInfo), sourceCodeInfo)) {
          throw new AssertionError(
            'Expected '
              .concat(JSON.stringify(first), ' to deep equal ')
              .concat(JSON.stringify(second), '.')
              .concat(message),
            sourceCodeInfo,
          )
        }
    ...
    assertNotEqual: {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (deepEqual(any.as(first, sourceCodeInfo), any.as(second, sourceCodeInfo), sourceCodeInfo)) {
          throw new AssertionError(
            'Expected '
              .concat(JSON.stringify(first), ' not to deep equal ')
              .concat(JSON.stringify(second), '.')
              .concat(message),
            sourceCodeInfo,
          )
    ...
    'assert>': {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (compare(first, second) <= 0) {
          throw new AssertionError(
            'Expected '.concat(first, ' to be grater than ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
    ...
    'assert>=': {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (compare(first, second) < 0) {
          throw new AssertionError(
            'Expected '.concat(first, ' to be grater than or equal to ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
    ...
    'assert<': {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (compare(first, second) >= 0) {
          throw new AssertionError(
            'Expected '.concat(first, ' to be less than ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
    ...
    'assert<=': {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        if (compare(first, second) > 0) {
          throw new AssertionError(
            'Expected '.concat(first, ' to be less than or equal to ').concat(second, '.').concat(message),
            sourceCodeInfo,
          )
        }
        return null
  ...
  var objectNormalExpression = {
    object: {
      ...
      validate: function (node) {
        return assertEventNumberOfParams(node)
      },
    },
    keys: {
      evaluate: function (_a, sourceCodeInfo) {
  ...
  var stringNormalExpression = {
      ...
      evaluate: function (params, sourceCodeInfo) {
        ...
        if (params.length === 1) {
          ...
          if (base !== 2 && base !== 8 && base !== 10 && base !== 16) {
            throw new LitsError(
              'Expected "number-to-string" base argument to be 2, 8, 10 or 16, got: '.concat(base),
              sourceCodeInfo,
            )
          }
          if (base === 10) {
    ...
    join: {
      evaluate: function (_a, sourceCodeInfo) {
        ...
        stringList.forEach(function (str) {
          return string.assert(str, sourceCodeInfo)
        })
    ...
    template: {
      evaluate: function (_a, sourceCodeInfo) {
        var templateString = _a[0],
          placeholders = _a.slice(1)
      ...
      validate: function (node) {
        return assertNumberOfParams({ min: 1, max: 10 }, node)
      },
    },
  }
  ...
  var normalExpressions = __assign(
    __assign(
      __assign(
        __assign(
          __assign(
            __assign(
              __assign(
                __assign(
                  __assign(
                    __assign(
                      __assign(__assign({}, bitwiseNormalExpression), collectionNormalExpression),
  ...
  function findOverloadFunction(overloads, nbrOfParams, sourceCodeInfo) {
    ...
    if (!overloadFunction) {
      throw new LitsError(
        'Unexpected number of arguments, got '.concat(valueToString$1(nbrOfParams), '.'),
        sourceCodeInfo,
      )
    }
  ...
  var functionExecutors = {
    ...
    partial: function (fn, params, sourceCodeInfo, contextStack, _a) {
      ...
      return executeFunction(
        fn.fn,
        __spreadArray(__spreadArray([], fn.params, true), params, true),
        sourceCodeInfo,
        contextStack,
      )
    },
    comp: function (fn, params, sourceCodeInfo, contextStack, _a) {
      ...
      if (fns.length === 0) {
        if (params.length !== 1) {
          throw new LitsError(
            '(comp) expects one argument, got '.concat(valueToString$1(params.length), '.'),
            sourceCodeInfo,
          )
        }
        return any.as(params[0], sourceCodeInfo)
      ...
      return any.as(
        fns.reduceRight(function (result, fn) {
    ...
    juxt: function (fn, params, sourceCodeInfo, contextStack, _a) {
      var executeFunction = _a.executeFunction
      return fn.fns.map(function (fn) {
        return executeFunction(toAny(fn), params, sourceCodeInfo, contextStack)
      })
    },
    ...
    fnil: function (fn, params, sourceCodeInfo, contextStack, _a) {
      var executeFunction = _a.executeFunction
      var fniledParams = params.map(function (param, index) {
        return param === null ? toAny(fn.params[index]) : param
      })
  ...
  var ContextStackImpl = /** @class */ (function () {
    ...
    ContextStackImpl.prototype.withContext = function (context) {
      return new ContextStackImpl(
        __spreadArray([context], this.stack, true),
        this.stack.length - this.numberOfImportedContexts,
      )
    }
  ...
  var executeFunction = function (fn, params, sourceCodeInfo, contextStack) {
    if (litsFunction.is(fn)) {
      return functionExecutors[fn.type](fn, params, sourceCodeInfo, contextStack, {
  ...
  function evaluateBuiltinNormalExpression(node, params, contextStack) {
    ...
    return normalExpression.evaluate(params, node.token.sourceCodeInfo, contextStack, {
      executeFunction: executeFunction,
    })
  }
  ...
  function evaluateStringAsFunction(fn, params, sourceCodeInfo) {
    ...
    throw new LitsError(
      'string as function expects Obj or integer parameter, got '.concat(valueToString$1(param)),
      sourceCodeInfo,
    )
  }
  ...
  var parseFnShorthand = function (tokens, position) {
    var firstToken = token.as(tokens[position], 'EOF')
    position += 1
    var _a = parseExpression(tokens, position),
      newPosition = _a[0],
      expressionNode = _a[1]
    var arity = 0
  ...
  var parseNormalExpression = function (tokens, position) {
    var _a
    var _b
    var _c = parseToken(tokens, position),
      newPosition = _c[0],
      fnNode = _c[1]
    var params
  ...
  var parseSpecialExpression = function (tokens, position) {
    var _a = token.as(tokens[position], 'EOF'),
      expressionName = _a.value,
      sourceCodeInfo = _a.sourceCodeInfo
    position += 1
    var _b = asValue(builtin.specialExpressions[expressionName], sourceCodeInfo),
      parse = _b.parse,
  ...
  var tokenizeRegexpShorthand = function (input, position, sourceCodeInfo) {
    ...
    var _b = tokenizeString(input, position + 1, sourceCodeInfo),
      stringLength = _b[0],
      token = _b[1]
    if (!token) {
      return NO_MATCH
    ...
    while (input[position] === 'g' || input[position] === 'i') {
      if (input[position] === 'g') {
        if (options.g) {
          throw new LitsError(
            'Duplicated regexp option "'.concat(input[position], '" at position ').concat(position, '.'),
            sourceCodeInfo,
          )
        }
        length += 1
    ...
    if (nameRegExp.test((_a = input[position]) !== null && _a !== void 0 ? _a : '')) {
      throw new LitsError(
        'Unexpected regexp option "'.concat(input[position], '" at position ').concat(position, '.'),
        sourceCodeInfo,
      )
    }
    return [
  ...
  var tokenizeModifier = function (input, position, sourceCodeInfo) {
    ...
    for (var _i = 0, modifiers_1 = modifiers; _i < modifiers_1.length; _i++) {
      ...
      if (
        input.substr(position, length_3) === modifier &&
        (!charAfterModifier || !nameRegExp.test(charAfterModifier))
      ) {
        var value = modifier
  ...
  function tokenize(input, debug) {
    ...
    while (position < input.length) {
      ...
      for (var _i = 0, tokenizers_1 = tokenizers; _i < tokenizers_1.length; _i++) {
        ...
        var _a = tokenize_1(input, position, sourceCodeInfo),
          nbrOfCharacters = _a[0],
          token = _a[1]
        // tokenizer matched
  ...
  function createContextStackFromParams(params) {
    var _a, _b
    var globalContext =
      (_a = params === null || params === void 0 ? void 0 : params.globalContext) !== null && _a !== void 0 ? _a : {}
    Object.assign(
      globalContext,
      createContextFromValues(params === null || params === void 0 ? void 0 : params.globals),
    )
    var contextStack = createContextStack(
      __spreadArray(
        [globalContext],
        (_b = params === null || params === void 0 ? void 0 : params.contexts) !== null && _b !== void 0 ? _b : [],
        true,
      ),
    )
    return contextStack
