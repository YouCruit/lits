...
describe(`collection functions`, () => {
  ...
  describe(`get`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(get "Albert" 1)`)).toEqual(Type.string.nilable())
      // expect(lits.getDataType(`(get [1 2 3] 1)`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get {:a 1 :b 2} 1)`)).toEqual(Type.unknown)
    })
  })
  ...
  describe(`get-in`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(get-in "Albert" nil)`)).toEqual(Type.nonEmptyString)
      // expect(lits.getDataType(`(get-in [] nil)`)).toEqual(Type.emptyArray)
      // expect(lits.getDataType(`(get-in [1 2] nil)`)).toEqual(Type.nonEmptyArray)
      // expect(lits.getDataType(`(get-in {} nil)`)).toEqual(Type.emptyObject)
      // expect(lits.getDataType(`(get-in { :a 12 } nil)`)).toEqual(Type.nonEmptyObject)
      // expect(lits.getDataType(`(get-in #"^test" nil)`)).toEqual(Type.regexp)
      // expect(lits.getDataType(`(get-in 123 nil)`)).toEqual(Type.integer.and(Type.positiveNumber))
      // expect(lits.getDataType(`(get-in false nil)`)).toEqual(Type.false)
      // expect(lits.getDataType(`(get-in "Albert" [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in [] [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in [1 2] [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in {} [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in #"^test" [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in 123 [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in false [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in "Albert" [1] nil)`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in [] [1] :abc)`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in [1 2] [1] 1)`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in {} [1] [])`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in #"^test" [1] {})`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in 123 [1] true)`)).toEqual(Type.unknown)
      // expect(lits.getDataType(`(get-in false [1] #"hey")`)).toEqual(Type.unknown)
    })
  })
  ...
  describe(`contains?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(contains? [] 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? [1] 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? [1 2 3] 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? (object) :a)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? (object :a 1 :b 2) :a)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? [] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? [1] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? [1 2 3] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? (object) 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? (object :a 1 :b 2) 2)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? "Albert" 0)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? "Albert" 5)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? "Albert" 6)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(contains? "Albert" -1)`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`has?`, () => {
    ...
    test(`dataTypes`, () => {
      // expect(lits.getDataType(`(has? [] 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? [1] 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? [1 2 3] 0)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? (object) :a)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? (object :a 1 :b 2) 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? (object :a 1 :b 2) :a)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? [] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? [1] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? [1 2 3] :1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? (object) 1)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? "Albert" :A)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? "Albert" :a)`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has? "Albert" 1)`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`has-some?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(has-some? [] [1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [1] [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [1] [1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [1 2 3] [0])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [1 2 3] [0 1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? (object) [:a])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? (object :a 1 :b 2) [0])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? (object :a 1 :b 2) [0 1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? "Albert" "xyz")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? "Albert" ["Alb" "ert"])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? "Albert" ["A"])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? "Albert" "xyzl")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [:a :b :c :d] "xyz")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-some? [:a :b :c :d] "xyzc")`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`has-every?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(has-every? [] [1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [1] [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [1] [1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [1 2 3] [0 1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [1 2 3] [1 2])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? (object) [:a])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? (object :a 1 :b 2) [0 1])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? (object :a 1 :b 2) [1 2])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? "Albert" "xyz")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? "Albert" ["Alb" "ert"])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? "Albert" ["A"])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? "Albert" "treblA")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [:a :b :c :d] "xyz")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(has-every? [:a :b :c :d] "dcba")`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`every?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(every? number? [1 2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? number? [:1 :2 :3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? number? [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? number? "")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? number? {})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? (fn [x] (zero? (mod x 2))) [2 4 6])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? (fn [x] (>= x :a)) "abc")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? (fn [x] (>= x :a)) "abC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`not-every?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(not-every? number? [1 2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? number? [:1 :2 :3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? number? [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? number? "")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? number? {})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? (fn [x] (zero? (mod x 2))) [2 4 6])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? (fn [x] (>= x :a)) "abc")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? (fn [x] (>= x :a)) "abC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-every? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`any?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(any? number? [1 2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? number? [1 :2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? number? [:1 :2 :3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? number? [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? number? "")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? number? {})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? (fn [x] (zero? (mod x 2))) [1 3 6])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? (fn [x] (zero? (mod x 2))) [1 3 5])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? (fn [x] (>= x :a)) "abc")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? (fn [x] (>= x :a)) "abC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? (fn [x] (>= x :a)) "ABC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(any? #(even? (second %1)) {:a 1 :b 3})`)).toEqual(Type.boolean)
    })
  })
  ...
  describe(`not-any?`, () => {
    ...
    test(`dataType`, () => {
      // expect(lits.getDataType(`(not-any? number? [1 2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? number? [1 :2 3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? number? [:1 :2 :3])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? number? [])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? number? "")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? number? {})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? (fn [x] (zero? (mod x 2))) [1 3 6])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? (fn [x] (zero? (mod x 2))) [1 3 5])`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? (fn [x] (>= x :a)) "abc")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? (fn [x] (>= x :a)) "abC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? (fn [x] (>= x :a)) "ABC")`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? #(even? (second %1)) {:a 2 :b 4})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? #(even? (second %1)) {:a 2 :b 3})`)).toEqual(Type.boolean)
      // expect(lits.getDataType(`(not-any? #(even? (second %1)) {:a 1 :b 3})`)).toEqual(Type.boolean)
    })
  })
