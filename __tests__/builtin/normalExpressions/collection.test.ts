...
describe(`collection functions`, () => {
  ...
  describe(`count`, () => {
    ...
    test(`getDataType`, () => {
      expect(lits.getDataType(`(count [])`)).toEqual(DataType.number)
      expect(lits.getDataType(`(count {})`)).toEqual(DataType.number)
      expect(lits.getDataType(`(count "Albert")`)).toEqual(DataType.number)
    })
  })
  ...
  describe(`get`, () => {
    ...
    test(`getDataType`, () => {
      expect(lits.getDataType(`(get "Albert" 1)`)).toEqual(DataType.nilableString)
  ...
  describe(`get-in`, () => {
    ...
    test(`getDataType`, () => {
      expect(lits.getDataType(`(get-in "Albert" nil)`)).toEqual(DataType.string)
      expect(lits.getDataType(`(get-in [] nil)`)).toEqual(DataType.array)
      expect(lits.getDataType(`(get-in [1 2] nil)`)).toEqual(DataType.array)
      expect(lits.getDataType(`(get-in {} nil)`)).toEqual(DataType.object)
      expect(lits.getDataType(`(get-in { :a 12 } nil)`)).toEqual(DataType.object)
      expect(lits.getDataType(`(get-in #"^test" nil)`)).toEqual(DataType.regexp)
      expect(lits.getDataType(`(get-in 123 nil)`)).toEqual(DataType.number)
      expect(lits.getDataType(`(get-in false nil)`)).toEqual(DataType.boolean)
