...
describe(`collection functions`, () => {
  ...
  describe(`count`, () => {
    ...
    test(`dataType`, () => {
      expect(lits.run(`(count ::empty-array)`)).toEqual(DataType.zero)
      expect(lits.run(`(count ::empty-object)`)).toEqual(DataType.zero)
      expect(lits.run(`(count ::non-empty-string)`)).toEqual(DataType.positiveInteger)
    })
  })
